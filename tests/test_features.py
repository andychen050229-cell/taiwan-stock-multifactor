...
class TestSelectByMutualInfo:
    ...
    def test_output_shape(self):
        ...
        selected, mi_scores = select_by_mutual_info(
            df, "label", feature_cols, {"features": {"selection": {"mi_threshold_percentile": 50}}}
        )
    ...
    def test_mi_filtering_reduces_features(self):
        ...
        selected_loose, _ = select_by_mutual_info(
            df, "label", feature_cols, {"features": {"selection": {"mi_threshold_percentile": 25}}}
        )
        selected_strict, _ = select_by_mutual_info(
            df, "label", feature_cols, {"features": {"selection": {"mi_threshold_percentile": 75}}}
        )
...
class TestRemoveHighVIF:
    ...
    def test_vif_reduces_collinear_features(self):
        ...
        remaining = remove_high_vif(
            df, feature_cols, {"features": {"selection": {"vif_max": 5, "rfecv_min_features": 2}}}
        )
    ...
    def test_preserves_minimum_features(self):
        ...
        remaining = remove_high_vif(
            df, feature_cols, {"features": {"selection": {"vif_max": 2, "rfecv_min_features": 5}}}
        )
    ...
    def test_returns_list_of_features(self):
        ...
        remaining = remove_high_vif(
            df, feature_cols, {"features": {"selection": {"vif_max": 10, "rfecv_min_features": 1}}}
        )
...
class TestRunFeatureSelection:
    ...
    def test_pipeline_returns_dict_with_keys(self):
        ...
        result = run_feature_selection(
            df, "label", {"features": {"selection": {"mi_threshold_percentile": 50, "vif_max": 10, "rfecv_min_features": 2}}}
        )
    ...
    def test_selection_reduces_features(self):
        ...
        result = run_feature_selection(
            df, "label", {"features": {"selection": {"mi_threshold_percentile": 50, "vif_max": 5, "rfecv_min_features": 5}}}
        )
